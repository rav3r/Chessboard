...
public:
 ...
 int main()
 {
   ...
   float screenH = 800;
   	...
   	sf::RenderWindow renderWindow(sf::VideoMode(screenW, screenH), "Chessboard", sf::Style::Close);
    ...
    circles[0].setPosition(sf::Vector2f(100, 100) - sf::Vector2f(2.5f, 2.5f));
    circles[1].setPosition(sf::Vector2f(screenW-100, 100) - sf::Vector2f(2.5f, 2.5f));
    circles[2].setPosition(sf::Vector2f(screenW-100, screenH-100) - sf::Vector2f(2.5f, 2.5f));
    circles[3].setPosition(sf::Vector2f(100, screenH-100) - sf::Vector2f(2.5f, 2.5f));
    for(int i=0; i<4; i++)
    {
